#!/bin/bash
#SBATCH --job-name=exp_resnet101
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_resnet101_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_resnet101_%j.err
...
# Experiment: ResNet101 (larger model)
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: ResNet101 (larger model)"
...
OUTPUT_DIR="./outputs/experiments/resnet101"
