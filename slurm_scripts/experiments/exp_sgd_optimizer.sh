#!/bin/bash
#SBATCH --job-name=exp_sgd_optimizer
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_sgd_optimizer_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_sgd_optimizer_%j.err
...
# Experiment: SGD Optimizer
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: SGD Optimizer"
...
OUTPUT_DIR="./outputs/experiments/sgd_optimizer"
