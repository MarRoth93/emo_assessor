#!/bin/bash
#SBATCH --job-name=exp_high_reg
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_high_reg_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_high_reg_%j.err
...
# Experiment: High Regularization
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: High Regularization"
...
OUTPUT_DIR="./outputs/experiments/high_reg"
