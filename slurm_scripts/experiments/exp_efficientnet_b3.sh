#!/bin/bash
#SBATCH --job-name=exp_efficientnet_b3
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_efficientnet_b3_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_efficientnet_b3_%j.err
...
# Experiment: EfficientNet-B3
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: EfficientNet-B3"
...
OUTPUT_DIR="./outputs/experiments/efficientnet_b3"
