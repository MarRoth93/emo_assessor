#!/bin/bash
#SBATCH --job-name=exp_very_high_reg
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_very_high_reg_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_very_high_reg_%j.err
...
# Experiment: Very High Regularization
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: Very High Regularization"
...
OUTPUT_DIR="./outputs/experiments/very_high_reg"
