#!/bin/bash
#SBATCH --job-name=exp_baseline
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_baseline_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_baseline_%j.err
...
# Experiment: Baseline (ResNet50 + Decoder)
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: Baseline (ResNet50 + Decoder)"
