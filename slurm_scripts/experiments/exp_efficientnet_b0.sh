#!/bin/bash
#SBATCH --job-name=exp_efficientnet_b0
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_efficientnet_b0_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_efficientnet_b0_%j.err
...
# Experiment: EfficientNet-B0 (smaller model)
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: EfficientNet-B0 (smaller model)"
...
OUTPUT_DIR="./outputs/experiments/efficientnet_b0"
