#!/bin/bash
#SBATCH --job-name=exp_high_aux_loss
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_high_aux_loss_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_high_aux_loss_%j.err
...
# Experiment: Higher Auxiliary Loss Weight
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: Higher Auxiliary Loss Weight"
...
OUTPUT_DIR="./outputs/experiments/high_aux_loss"
