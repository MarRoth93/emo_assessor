#!/bin/bash
#SBATCH --job-name=exp_best_combo
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_best_combo_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_best_combo_%j.err
...
# Experiment: Best Combination (small model + high reg + low LR)
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: Best Combination (small model + high reg + low LR)"
...
OUTPUT_DIR="./outputs/experiments/best_combo"
