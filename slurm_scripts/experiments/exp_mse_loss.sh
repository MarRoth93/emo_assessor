#!/bin/bash
#SBATCH --job-name=exp_mse_loss
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_mse_loss_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_mse_loss_%j.err
...
# Experiment: MSE Loss Function
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: MSE Loss Function"
...
OUTPUT_DIR="./outputs/experiments/mse_loss"
