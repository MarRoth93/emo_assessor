#!/bin/bash
#SBATCH --job-name=exp_low_lr
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_low_lr_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_low_lr_%j.err
...
echo "=================================================="
echo "Experiment: Lower Learning Rate"
...
OUTPUT_DIR="./outputs/experiments/low_lr"
