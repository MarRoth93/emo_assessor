#!/bin/bash
#SBATCH --job-name=exp_efficientnet_b0_high_reg
#SBATCH --output=/home/rothermm/new_assessor/logs/exp_efficientnet_b0_high_reg_%j.out
#SBATCH --error=/home/rothermm/new_assessor/logs/exp_efficientnet_b0_high_reg_%j.err
...
# Experiment: EfficientNet-B0 + High Reg
# Architecture: PCA + Decoder
echo "=================================================="
echo "Experiment: EfficientNet-B0 + High Reg"
...
OUTPUT_DIR="./outputs/experiments/efficientnet_b0_high_reg"
